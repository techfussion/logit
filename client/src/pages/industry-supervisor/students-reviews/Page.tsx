                ...
                (
                    <div className="mt-6 flex justify-center items-center h-full">
                        <div className='flex flex-col items-center'>
                            ...
                            <p className="text-lg text-gray-400 mb-6 font-keyphodo">You currently don't have any Intern</p>
                        </div>
                    </div>
                )
                :
                            ...
                            interns.map((intern, index) => 
                                (
                                    <div key={index} className='mb-6'>
                                        <h1 className='text-xs mb-4 text-gray-500 font-kayphodo'>Select an intern</h1>
                                        <div className='w-full'>
                                            <Card className="border-none rounded-none flex justify-between w-full px-6 py-2 cursor-pointer hover:scale-105 duration-150"
                                                onClick={() => navigate(`/engine/supervisor-industry-reviews/${intern.id}`)}
                                            >
                                                <div className="flex w-full justify-between">
                                                    <h2 className="text-sm font-kayphodo text-gray-500">{intern?.firstName + ' ' + intern?.lastName}</h2>
                                                </div>
                                                <p className='text-[10px] whitespace-nowrap text-gray-400'>Click to view reviews</p>
                                            </Card>
                                        </div>
                                    </div>
                                )
