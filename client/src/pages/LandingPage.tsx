  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div>
              <div className="flex flex-col items-center space-y-4 my-10">
                <div className="flex items-center flex-col space-y-3 text-center">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text font-montserrat">
                    Simplify Your Logging with logit
                  </h1>
                  <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 font-montserrat">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 font-montserrat">Key Features</h2>
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                <LucidePhone className="h-12 w-12 text-primary" />
              ...
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                <CheckCircle className="h-12 w-12 text-primary text-customGreen1" />
              ...
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                <FileText className="h-12 w-12 text-primary text-customBlue1" />
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 font-montserrat">How logit Works</h2>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-customBlue1 text-3xl font-bold text-white">1</div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-customBlue1 text-3xl font-bold text-white">2</div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-customBlue1 text-3xl font-bold text-white">3</div>
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 font-montserrat">What Our Users Say</h2>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                  "logit has revolutionized how I track my work hours. It's intuitive and saves me so much time!"
                </p>
                <p className="text-sm font-bold text-customBlue1">- Sarah K., Freelance Designer</p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                  "As a project manager, logit helps me keep my team's activities organized and easily accessible."
                </p>
                <p className="text-sm font-bold text-customBlue1">- John D., Project Manager</p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 dark:border-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                  "The mobile app is a game-changer. I can log my activities on-the-go, making my workday much more efficient."
                </p>
                <p className="text-sm font-bold text-customBlue1">- Emily R., Sales Representative</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-primary-foreground/90 md:text-xl">
                  Join thousands of studenst who have simplified their logging process with logit.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-primary-foreground/90">
                  Start your smart logging proccess. It's totally free!!!
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 logit Inc. All rights reserved.</p>
