...
const EditProfileDialog: React.FC<EditProfileDialogProps> = ({ triggerButton }) => {
        ...
        <DialogTrigger>
          {
            ...
            ? 
              triggerButton 
            : 
              <Button variant="outline" className="text-[10px] h-6 rounded-none font-kayphodo w-max" onClick={() => {}}>
                  Edit
              </Button>
        ...
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription className="text-xs">
                    Fill the form bellow to update your editable profile data
                </DialogDescription>
            </DialogHeader>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} action="" className="max-h-96 overflow-y-scroll px-2 space-y-4">
                    <FormField
